...
local FirstButton = FirstPage.AddButton("Cam Aimlock [E]", function()
...
local FirstButton = FirstPage.AddButton("Smooth Cam Lock [E]", function()
...
local FirstButton = FirstPage.AddButton("Dot Lock OP [E]", function()
local Settings = {
    rewrittenmain = {
        Enabled = true,
        Key = "e",
