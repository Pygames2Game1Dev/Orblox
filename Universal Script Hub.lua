--[[
On the top of the UI 3 Buttons/Circle you can click that then you can click settings for 
A Script Hub and on the top of settings is a internal UI that is like an executor.
--]]

local VLib = loadstring(game:HttpGet("https://gitlab.com/L1ZOT/test-project/-/raw/main/PJM-GUI"))()
local Win = VLib:Window("Project Beta", "Universal")
